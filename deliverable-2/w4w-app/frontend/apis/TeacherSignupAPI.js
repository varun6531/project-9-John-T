...
async function TeacherSignupAPI (email, password, password2, firstName, lastName, age, city, country, school) {
    var zambonie;
    var costa = 0;
    zambonie = await fetch(base_url + 'accounts/register-teacher/', {
        method: 'POST',
        headers: {
