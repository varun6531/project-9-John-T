...
export default function PostQ2({ navigation }){
    return (
        <View style={styles.background}>
            <Text style={styles.textCaption}>Question 2</Text>
            <Text style={styles.subtext}>
                Do you think water and its use around the world
                is fair and equal? Should people have the same 
                access to water everywhere?
            </Text>
            <TextInput
                multiline
                numberOfLines={6}
            ...
            <View style = {styles.inputview}>
                <Pressable style={styles.button} onPress={() => navigation.navigate("Submit response")}>
